...
if (isAdmin) {
  ...
  do {
    ...
    for (let i = 0; i < customizedPriceFlightsArr.length; i++) {
      customizedPriceFlightsArr[i].scale ? flightWithScale = 'it is a non-stop flight' : flightWithScale = 'it has scales';
      console.log(`The flight from ${customizedPriceFlightsArr[i].from} to ${customizedPriceFlightsArr[i].to} costs ${customizedPriceFlightsArr[i].cost} € and ${flightWithScale}`);
    }
